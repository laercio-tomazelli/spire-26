...
<svg xmlns="http://www.w3.org/2000/svg" class="hidden">
    <defs>
        ...
        <symbol id="icon-wrench" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round"
                d="M14.828 14.828a4 4 0 10-5.656-5.656l-1.414 1.414-2.828-2.828 1.414-1.414A6 6 0 1116.242 16.24l-1.414-1.412z" />
            <path stroke-linecap="round" stroke-linejoin="round"
                d="M20.5 3.5l-1.06 1.06a2 2 0 11-2.828-2.828L17.672.672A2 2 0 0120.5 3.5z" />
        </symbol>
