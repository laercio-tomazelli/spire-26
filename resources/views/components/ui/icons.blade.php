...
<svg xmlns="http://www.w3.org/2000/svg" class="hidden">
    <defs>
        ...
        <symbol id="icon-dots-vertical" viewBox="0 0 24 24" fill="currentColor">
            <path
                d="M12 5a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm0 6.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm0 6.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
        </symbol>

        <symbol id="icon-dots-horizontal" viewBox="0 0 24 24" fill="currentColor">
            <path
                d="M5 12a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm6.5 0a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm6.5 0a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
        </symbol>
        ...
        {{-- Inventory/Stock --}}
        <symbol id="icon-arrow-down-tray" viewBox="0 0 24 24" fill="none" stroke="currentColor"
            stroke-width="1.5">
            <path stroke-linecap="round" stroke-linejoin="round"
                d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" />
        </symbol>

        <symbol id="icon-arrow-up-tray" viewBox="0 0 24 24" fill="none" stroke="currentColor"
            stroke-width="1.5">
            <path stroke-linecap="round" stroke-linejoin="round"
                d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5m-13.5-9L12 3m0 0 4.5 4.5M12 3v13.5" />
        </symbol>

        <symbol id="icon-building-storefront" viewBox="0 0 24 24" fill="none" stroke="currentColor"
            stroke-width="1.5">
            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <symbol id="icon-cpu-chip" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <symbol id="icon-cog" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
            <path stroke-linecap="round" stroke-linejoin="round"
