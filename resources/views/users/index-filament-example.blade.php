...
<x-layouts.module title="Usuários">
    ...
    {{-- Table Container --}}
    <div id="users-table-container" data-url="{{ route('users.filament') }}" data-csrf="{{ csrf_token() }}"
                        ...
                        <x-ui.table.filters :activeCount="$activeFiltersCount ?? 0">
                            <div>
                                ...
                                <x-spire::select name="filter_user_type" placeholder="Todos" :options="$userTypes"
                                    ...
                                    onchange="window.dispatchEvent(new CustomEvent('table-filter-change', { detail: { key: 'user_type', value: this.value }}))" />
                            </div>
                            <div>
                                <label
                                ...
                                <x-spire::select name="filter_is_active" placeholder="Todos" :options="\App\Enums\Status::selectOptions()"
                                    ...
                                    onchange="window.dispatchEvent(new CustomEvent('table-filter-change', { detail: { key: 'is_active', value: this.value }}))" />
                            </div>
