    ...
    <x-spire::card class="mb-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                <a href="https://spire-26.wks.dev/users/create" data-v="button"
                    class="inline-flex items-center justify-center h-9 px-4 text-sm rounded-lg font-medium transition focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-60 disabled:cursor-not-allowed text-white bg-blue-600 hover:bg-blue-700 focus:ring-blue-500">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
