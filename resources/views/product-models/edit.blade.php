            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <x-spire::card>
                    ...
                    <x-spire::textarea name="observations" rows="4"
                        placeholder="Observações adicionais sobre o modelo..." :value="old('observations', $productModel->observations)" :error="$errors->first('observations')" />
                </x-spire::card>
            </div>
            ...
            <div class="space-y-6">
                ...
                <x-spire::card>
                    ...
                    <x-spire::checkbox name="is_active" label="Ativo" hint="Modelos inativos não aparecem para seleção"
                        size="lg" :checked="old('is_active', $productModel->is_active)" />
                </x-spire::card>
